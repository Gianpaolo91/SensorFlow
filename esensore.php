...
<head>
	...
	<title>Sensor Flow - Elimina Sensore</title>
		...
		<div class="main_container">
			...
			<div class="right_col" role="main">
				...
				<div class="row">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						...
						<script>
							...
							<input type="text" name="sensore" id="sensore" readonly class="form-control" required ></input>
							  ...
							  <br>
							<div>
				            <input id="elimina" name="elimina" placeholder="Seleziona un sensore" type="submit" value="Elimina sensore" class="btn btn-primary"></input>
							</div>
							</form>
					       <br>
					...
					$db = DB::getInstance();
					try{$db->delete('sensore',array("id_sensore","=",$id_sensore));
						echo 'Sensore eliminato correttamente';
						}catch(Exception $e){
